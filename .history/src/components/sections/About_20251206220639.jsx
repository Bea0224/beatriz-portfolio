                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                    <div className="flex flex-col items-start justify-center p-6 rounded-xl border-white/10 border hover:-translate-y-l transition-all gap-4">
                        ...
                        <div>
                            ...
                            <ul>
                                <li>
                                    <strong>SCRUM MASTER CERTIFIED</strong> - Universidad Las Palmas de Gran Canaria, Junio 2019.
                                SCRUM MASTER CERTIFIED.
EIGP. 150PDAs. Junio 2025.
Curso Wordpress, HTML y CSS, UX Marketing online, SEO Y SEM.
Escuela de Organización Industrial. 147,50 horas, Julio 2020.
Curso Creación, programación y diseño de páginas web.
Instituto Focan. 60 horas, Febrero 2020.
                                </li>
                            </ul>
                        </div>
                    </div>
