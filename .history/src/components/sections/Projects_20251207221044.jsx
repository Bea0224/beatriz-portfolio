            ...
            <div className="max-w-5xl mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="rounded-xl p-6 hover:-translate-y-l transition-all">
                        ...
                        <div>
                            {["React", "HTML", "CSS", "JavaScript", "Django", "PostgreSQL", "GitLab CI/CD", "Docker"].map((tech, key)=>(
                                <span 
                                    key={key}
                                    className="bg-blue-500/10 text-blue-500 py-1 px-2 rounded-full text-sm hover:bg-blue-500/   
                            )]}
                        </div>
                    </div>
                </div>
