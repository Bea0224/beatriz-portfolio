        ...
        >
            <div className="max-w-5xl mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-l hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,2246,0.2)] transition transition-all">
                        <h3 className="text-xl font-bold mb-4"> Heracles - Plataforma Interna de Automatización y Gestión de Red</h3>
                        <p>
