                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                    ...
                    <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-l transition-all">
                        ...
                        <div className="space-y-4 text-gray-300">
                            ...
                            <div>
                                <h4>Salesforce Developer en Italtel S.A. (12 de May. 2023 - 11 de Dic. 2023).</h4>
                                <p>
                                    Desarrollo, mantenimiento y mejora de las funcionalidades del portal clientes CRM 360 TGS.
                                </p>
                            </div>
                            <div>
                                <h4>Salesforce Developer en Between Technology. (14 de Nov. 2022 - 12 de May. 2023).</h4>
                                <p>
                                    Desarrollo, mantenimiento y mejora de las funcionalidades del portal clientes CRM 360 TGS.
                                </p>
                            </div>
                            <div>
                                <h4>Salesforce Developer en Beca Telefónica Talentum. (11 de Nov. 2021 - 14 de May. 2023).</h4>
                                <p>
                                    Desarrollo, mantenimiento y mejora de las funcionalidades del portal clientes CRM 360 TGS.
                                </p>
                            </div>
