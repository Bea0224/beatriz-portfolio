                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                    ...
                    <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-l transition-all">
                        ...
                        <div className="space-y-4 text-gray-300">
                            <div>
                                <h4>Software Developer en Italtel S.A. (11 de Dic. 2023 - Actualmente).</h4>
                                <p>
                                    Proyecto Heracles para TDE: Desarrollo, mantenimiento y mejora de funcionalidades.
                                    Control de Versiones: Gestión de Jira y control de versiones entre entornos con GIT.
                                    Stock Tecnológico: Competencia en programación tanto back-end como front-end,
                                    utilizando los frameworks Django y React.
                                    Lenguajes de Programación: Habilidad en Python, HTML, CSS, JavaScript, entre otros.
                                </p>
                            </div>
