                    ...
                    <div className="flex flex-col items-start justify-center p-6 rounded-xl border-white/10 border hover:-translate-y-l transition-all gap-4">
                        ...
                        <div>
                            ...
                            <ul className="list-disc list-inside text-gray-300 space-y-2">
                                ...
                                <li className="mb-2">
                                    <strong> Curso Gestión del Marketing y comunicación (COMM0112) </strong> - Nascor Formación. 40 horas Diciembre 2023.
                                </li>
                                Curso Gestión del Marketing y comunicación (COMM0112) .
Grupo Aspasia. 800 horas. Agosto 2020.
                                <li className="mb-2">
